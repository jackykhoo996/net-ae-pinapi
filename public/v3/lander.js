(function () {
  ...
  var translations = {
    ar: {
      ...
      free_badge:      'مجاناً',
      proof_joined:    'لاعباً انضم اليوم',
      trust_secure:    'آمن 100%',
      trust_instant:   'فوري',
    ...
    en: {
      ...
      free_badge:      'FREE',
      proof_joined:    'players joined today',
      trust_secure:    '100% Secure',
      trust_instant:   'Instant',
      trust_cancel:    'Cancel free',
  ...
  var baseCount = 280 + Math.floor(Math.random() * 60);
  ...
  btnRequest.addEventListener('click', function () {
    ...
    fetch('/api/request-pin', {
      ...
      body: JSON.stringify({ msisdn: msisdn, click_id: clickId, lander: 'v3' })
    })
